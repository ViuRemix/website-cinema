...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-container">
      ...
      <p>
        Khi bạn sử dụng dịch vụ của chúng tôi, chúng tôi có thể thu thập các
        thông tin sau:
      </p>
      <ul>
        ...
        <li>
          Thông tin hành vi: cách bạn tương tác với dịch vụ (như xem trang, thời
          gian sử dụng).
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>Phân tích và tối ưu hóa hiệu suất dịch vụ.</li>
      ...
      <p>
        Chúng tôi áp dụng các biện pháp bảo mật kỹ thuật và tổ chức để bảo vệ
        thông tin cá nhân của bạn khỏi truy cập, sử dụng, hoặc tiết lộ trái
        phép.
      </p>

      <h2>5. Chính Sách Xóa Dữ Liệu</h2>
      <p>
      ...
      <p>
        ...
        Nếu có thay đổi lớn, chúng tôi sẽ thông báo cho bạn qua email hoặc trên
