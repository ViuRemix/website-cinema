...
function CustomerForm() {
  ...
  return (
    <div className="customer-inquiry-form" style={{ maxWidth: '400px', margin: '0 auto', padding: '20px' }}>
      ...
      {submitted && <p style={{ color: 'green' }}>Thank you for your question. We will respond soon!</p>}
    </div>
  );
}
